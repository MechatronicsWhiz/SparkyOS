...
class DesktopFileCreator(QWidget):
    ...
    def initUI(self):
        ...
        self.create_button = QPushButton('Create Desktop File')
...
Categories=Utility;'''  # Customize Categories as needed
        ...
        try:
            ...
            QMessageBox.information(self, 'Success', f'Desktop file created: {desktop_file_path}')
    ...
    def restart_panel(self):
        ...
        try:
            ...
            QMessageBox.critical(self, 'Error', f'Failed to restart LXQt panel: {e}')
